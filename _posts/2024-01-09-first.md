...
<center>
<iframe class="slideshow-iframe" id="execution-registers" src={{"/assets/html/register-sequence.html" | absolute_path}}
...
<center><div  class="figure-container-small"><figure>
	<img src={{"/assets/images/register-sp.png" | absolute_path}} class="figure">
...
<figure>
	<img src={{"/assets/images/register-8.png" | absolute_path}} alt="Register 8 calling convention" class="figure">
...
<center><div  class="figure-container"><figure>
	<img src={{"/assets/images/rip-1.png" | absolute_path}} class="figure2">
  <img src={{"/assets/images/rip-2.png" | absolute_path}} class="figure2">
...
<center><div  class="figure-container"><figure>
	<img src={{"/assets/images/RFLAGS.png" | absolute_path}} alt="RFLAGS" class="figure">
...
<center><div  class="figure-container"><figure>
	<img src={{"/assets/images/stack-frame-dark.png" | absolute_path}} alt="RFLAGS" class="figure2">
...
<center>
<iframe class="slideshow-iframe" id="execution-function" src={{"/assets/html/function-sequence.html" | absolute_path}}
frameborder="0" scrolling="no" onload="resizeIframe(this)"></iframe>
</center>
...
<center><div  class="figure-container"><figure>
<img src={{"/assets/images/syscalls.png" | absolute_path}} class="figure2">
