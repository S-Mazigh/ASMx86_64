...
<center>
<iframe class="slideshow-iframe" id="execution-registers" src="{{ site.url }}/assets/html/register-sequence.html"
...
<center><div  class="figure-container-small"><figure>
	<img src="{{ site.url }}/assets/images/register-sp.png" class="figure">
...
<figure>
	<img src="{{ site.url }}/assets/images/register-8.png" alt="Register 8 calling convention" class="figure">
...
<center><div  class="figure-container"><figure>
	<img src="{{ site.url }}/assets/images/rip-1.png" class="figure2">
  <img src="{{ site.url }}/assets/images/rip-2.png" class="figure2">
...
<center><div  class="figure-container"><figure>
	<img src="{{ site.url }}/assets/images/RFLAGS.png" alt="RFLAGS" class="figure">
...
<center><div  class="figure-container"><figure>
	<img src="{{ site.url }}/assets/images/stack-frame-dark.png" alt="RFLAGS" class="figure2">
...
<center>
<iframe class="slideshow-iframe" id="execution-function" src="{{ site.url }}/assets/html/function-sequence.html"
frameborder="0" scrolling="no" onload="resizeIframe(this)"></iframe>
</center>
...
<center><div  class="figure-container"><figure>
<img src="{{ site.url }}/assets/images/syscalls.png" class="figure2">
